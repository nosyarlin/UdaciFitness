  ...
  setLocation = () => {
    Location.watchPositionAsync({
      ...
      if (newDirection !== direction) {
        Animated.sequence([
          Animated.timing(bounceValue, { duration: 2, toValue: 1.04 }),
    ...
    if (status === 'denied') {
      return (
        <View style={styles.center}>
          ...
          <Text>You denied your location. You can fix this by visiting your 
          settings and enabling location services for this app.</Text>
        </View>
      );
    }
